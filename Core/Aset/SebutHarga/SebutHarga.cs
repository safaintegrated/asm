...
namespace Core.Aset.SebutHarga
{
    public class SebutHargaMethods
    {
        public static string SP_TawaranSebutHarga_FindRecord(string ProcessId, ref DataSet ReturnDs)
        {
            ...
            try
            {
                ...
                sqlCmd.CommandText = "SP_TawaranSebutHarga_FindRecord";
        ...
        public static string SP_TawaranSebutHarga_SaveDelete(ref DataTable TVP_Header, ref DataTable TVP_Detail, string CurrUser, int Mode)
        {
            SqlConnection sqlConn = new SqlConnection();  //defines database connection
            SqlCommand sqlCmd = new SqlCommand();  //defines what to do
            ...
            try
            {
                ...
                sqlCmd.CommandText = "SP_TawaranSebutHarga_SaveDelete";
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.Connection = sqlConn;
        ...
        public static string SP_TawaranSebutHarga_GetReference(string ProcessId, ref DataTable ReturnDt)
        {
            SqlConnection sqlConn = new SqlConnection();  //defines database connection
            SqlCommand sqlCmd = new SqlCommand();  //defines what to do
            SqlDataAdapter sqlAdap = new SqlDataAdapter();
            ...
            try
            {
                ...
                sqlCmd.CommandText = "SP_TawaranSebutHarga_GetReference";
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.Connection = sqlConn;
        ...
        public static string GetProcessId(ref string ProcessId, string SebutHargaNumber)
        {
            SqlConnection sqlConn = new SqlConnection();  //defines database connection
            SqlCommand sqlCmd = new SqlCommand();  //defines what to do
            SqlDataAdapter sqlAdap = new SqlDataAdapter();
            ...
            try
            {
                ...
                sqlCmd.CommandText = "SELECT  [TSH_ProcessID] FROM [AMS_Master].[dbo].[TawaranSebutHarga_Header] H WHERE [TSH_NoSebutHarga] = '" + SebutHargaNumber + "'";
