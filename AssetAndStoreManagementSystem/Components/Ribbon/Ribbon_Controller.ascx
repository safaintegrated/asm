<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Ribbon_Controller.ascx.cs" Inherits="AssetAndStoreManagementSystem.Components.Ribbon.Ribbon_Controller" %>
...
<dx:ASPxRibbon ID="MainRibbon" runat="server" ShowFileTab="False" ClientInstanceName="MainRibbon" Width="100%" ActiveTabIndex="2">
    <Tabs>
                ...
                <dx:RibbonGroup>
                    ...
                    <Items>
                        <dx:RibbonDropDownButtonItem Name="Cetak" Size="Large" Text="Cetak">
                            <Items>
                                <dx:RibbonDropDownButtonItem Name="Cetak PR" Text="Cetak PR">
                                </dx:RibbonDropDownButtonItem>
                                <dx:RibbonDropDownButtonItem Name="Cetak Senarai" Text="Cetak Senarai">
                                </dx:RibbonDropDownButtonItem>
                            </Items>
                            <LargeImage IconID="print_print_32x32">
                            </LargeImage>
