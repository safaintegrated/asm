<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Pelupusan_Controller.ascx.cs" Inherits="AssetAndStoreManagementSystem.Aset.Pelupusan.Pelupusan_Controller" %>
...
<%@ Register src="Pelupusan_Pemeriksaan_Controller.ascx" tagname="Pelupusan_Pemeriksaan_Controller" tagprefix="uc1" %>
<%@ Register src="Pelupusan_Perakuan_Controller.ascx" tagname="Pelupusan_Perakuan_Controller" tagprefix="uc2" %>
<%@ Register src="Pelupusan_MaklumatPelupusan_Controller.ascx" tagname="Pelupusan_MaklumatPelupusan_Controller" tagprefix="uc3" %>
	...
	MainRibbon_CommandExecuted(s, e);
        ...
        <tr>
            <td style="width:80%; vertical-align:top; text-align:left; padding-top:10px;">
                <dx:ASPxPageControl ID="PageControl" runat="server" ActiveTabIndex="0" Width="100%" AccessibilityCompliant="True" ClientInstanceName="PageControl" ClientVisible="False">
                    <TabPages>
                        <dx:TabPage Text="Maklumat Pelupusan">
                            <ContentCollection>
                                <dx:ContentControl runat="server">
                                    <uc3:Pelupusan_MaklumatPelupusan_Controller ID="Pelupusan_MaklumatPelupusan_Controller1" runat="server" />
                                </dx:ContentControl>
                            </ContentCollection>
                        </dx:TabPage>
                        <dx:TabPage Text="Perakuan">
                            <ContentCollection>
                                <dx:ContentControl runat="server">
                                    <uc2:Pelupusan_Perakuan_Controller ID="Pelupusan_Perakuan_Controller1" runat="server" />
                                </dx:ContentControl>
                            </ContentCollection>
                        </dx:TabPage>
                        <dx:TabPage Text="Pemeriksaan">
                            <ContentCollection>
                                <dx:ContentControl runat="server">
                                    <uc1:Pelupusan_Pemeriksaan_Controller ID="Pelupusan_Pemeriksaan_Controller1" runat="server" />
                                </dx:ContentControl>
                            </ContentCollection>
                        </dx:TabPage>
                    </TabPages>
