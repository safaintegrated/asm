<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Lelong_Controller.ascx.cs" Inherits="AssetAndStoreManagementSystem.Aset.Lelong.Lelong_Controller" %>
<%@ Register assembly="DevExpress.Web.v14.2, Version=14.2.3.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web" tagprefix="dx" %>
<%@ Register src="Tab_Maklumat.ascx" tagname="Tab_Maklumat" tagprefix="uc2" %>

<link href="../../Public/Css/FormsCss.css" rel="stylesheet" />
<script>
    function KenyataanLelongSelected(ProcessId) {
        KLH_ProcessID.SetText(ProcessId.toString());
        LoadingPanel.SetText('Sistem sedang membuka maklumat Kenyataan Lelong yang dipilih.  Sila tunggu sebentar..');
        LoadingPanel.Show();
    ...
    function TambahClicked() {
        LoadingPanel.SetText('Sistem sedang bersedia untuk menerima rekod Kenyataan Lelong baharu.  Sila tunggu sebentar..');
        LoadingPanel.Show();
    ...
    function SimpanClicked() {
        if (CheckHeaderBeforeSave() && CheckGridBeforeSave()) {
            LoadingPanel.SetText('Sistem sedang menyimpan rekod Kenyataan Lelong.  Sila tunggu sebentar..')
            LoadingPanel.Show();
    ...
    function BatalCicked() {
        if (Ref_RefProcessId.GetText() == '') {
            ...
            LoadingPanel.SetText('Sistem sedang memuat semula rekod Kenyataan Lelong yang terakhir disimpan.  Sila tunggu sebentar..')
            LoadingPanel.Show();
            cbp.PerformCallback('LOAD')
        }
    }
    ...
    function CheckHeaderBeforeSave() {
        if (
                KLH_NoLelongan.GetText() == '' ||
                KLH_AuctionDate.GetText() == '' ||
                KLH_AuctionLocation.GetText() == '' ||
                KLH_ViewStartDate.GetText() == '' ||
                KLH_ViewEndDate.GetText() == '' ||
                KLH_ViewLocation.GetText() == '' ||
                KLH_ReservedPrice.GetText() == '' 
            ) {
    ...
    function ProceedWithDeleteHeader() {
        LoadingPanel.SetText('Sistem sedang memadam rekod Kenyataan Lelong yang dipilih.  Sila tunggu sebentar..');
        LoadingPanel.Show();
...
<dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" HeaderText="Kenyataan Lelong" Width="100%">
    <HeaderImage Url="~/Public/Images/Screen/Auction.png">
    </HeaderImage>
...
<dx:PanelContent ID="PanelContent1" runat="server">
    <table style="width:100%; vertical-align:top; text-align:left">
        <tr>
            <td colspan="2" class="auto-style1"><dx:ASPxRibbon ID="MainRibbon" runat="server" ShowFileTab="False" ClientInstanceName="MainRibbon" Width="100%">
    <Tabs>
	...
	MainRibbon_CommandExecuted(s, e);
        ...
        <tr>
            <td style="width:75%; vertical-align:top; text-align:left; padding-top:10px;">
                <uc2:Tab_Maklumat runat="server" ID="Tab_Maklumat" />
            </td>
            <td style="width:25%; vertical-align:top; text-align:left; padding-top:10px;">
                                             ...
                                             <dx:LayoutItem Caption="No. Rujukan">
                                                 <LayoutItemNestedControlCollection>
                                                     <dx:LayoutItemNestedControlContainer runat="server">
                                                         <dx:ASPxTextBox ID="Ref_RefNumber" runat="server" ClientEnabled="False" ClientInstanceName="Ref_RefNumber" CssClass="TextBoxForId" EnableClientSideAPI="True" Width="100%">
                                                         </dx:ASPxTextBox>
...
<dx:ASPxPopupControl ID="popupSearch" runat="server" AllowDragging="True" ClientInstanceName="popupSearch" EnableClientSideAPI="True" HeaderText="Carian Kenyataan Lelong" MaxHeight="650px" MinHeight="450px" MinWidth="650px" Modal="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter">
    <HeaderImage Url="~/Public/Images/DialogBox/Lookup.png">
    </HeaderImage>    
    <ContentCollection>
        <dx:PopupControlContentControl ID="PopupControlContentControl1" runat="server">
            <dx:ASPxGridView ID="GridSearch" runat="server" AutoGenerateColumns="False" ClientInstanceName="GridSearch" DataSourceID="SearchDs" EnableCallbackAnimation="True" KeyFieldName="KLH_ProcessID" OnCustomCallback="GridSearch_CustomCallback" Width="100%" OnHtmlDataCellPrepared="GridSearch_HtmlDataCellPrepared">
                <Columns>
                    <dx:GridViewDataTextColumn FieldName="KLH_ProcessID" ReadOnly="True" ShowInCustomizationForm="True" Visible="False" VisibleIndex="0">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="No. Rujukan" FieldName="KLH_RefNumber" ShowInCustomizationForm="True" VisibleIndex="1">
                        <HeaderStyle HorizontalAlign="Left" VerticalAlign="Bottom" Wrap="True" />
                        <CellStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True">
                        </CellStyle>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="No. Kenyataan Lelong" FieldName="KLH_NoLelongan" ShowInCustomizationForm="True" VisibleIndex="2">
                         <HeaderStyle HorizontalAlign="Left" VerticalAlign="Bottom" Wrap="True" />
                        <CellStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True">
                        </CellStyle>
                        <DataItemTemplate>
                            <dx:ASPxHyperLink ID="KLH_NoLelongan" EnableClientSideAPI="true" runat="server" Text="ASPxHyperLink">
                            </dx:ASPxHyperLink>
                        </DataItemTemplate>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataDateColumn Caption="Tarikh" FieldName="KLH_AuctionDate" ShowInCustomizationForm="True" VisibleIndex="3" PropertiesDateEdit-DisplayFormatString="dd/MM/yyyy">
                    ...
                    <dx:GridViewDataDateColumn Caption="" FieldName="KLH_AuctionLocation" ShowInCustomizationForm="True" VisibleIndex="4" PropertiesDateEdit-DisplayFormatString="dd/MM/yyyy">
                        <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy"></PropertiesDateEdit>
                    ...
                    <dx:GridViewDataTextColumn Caption="Harga Simpanan" FieldName="KLH_ReservedPrice" ShowInCustomizationForm="True" VisibleIndex="5" PropertiesTextEdit-DisplayFormatString="n">
            ...
            <asp:SqlDataSource ID="SearchDs" runat="server" ConnectionString="<%$ ConnectionStrings:AMS_MasterConnectionString %>" SelectCommand="SELECT [KLH_ProcessID], [KLH_RefNumber], [KLH_NoLelongan], [KLH_AuctionDate], [KLH_AuctionLocation], [KLH_ReservedPrice] FROM [KenyataanLelong_Header] ORDER BY [KLH_RefNumber]"></asp:SqlDataSource>
