<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SebutHarga_Controller.ascx.cs" Inherits="AssetAndStoreManagementSystem.Aset.SebutHarga.SebutHarga_Controller" %>
<%@ Register assembly="DevExpress.Web.v14.2, Version=14.2.3.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web" tagprefix="dx" %>
<%@ Register src="Tab_Maklumat.ascx" tagname="Tab_Maklumat" tagprefix="uc1" %>
<%@ Register Src="~/Aset/SebutHarga/Tab_Maklumat.ascx" TagPrefix="uc2" TagName="Tab_Maklumat" %>


<link href="../../Public/Css/FormsCss.css" rel="stylesheet" />
<script>
    function TawaranSebutHargaSelected(ProcessId) {
        TSH_ProcessID.SetText(ProcessId.toString());
        LoadingPanel.SetText('Sistem sedang membuka maklumat Tawaran Sebutharga yang dipilih.  Sila tunggu sebentar..');
        LoadingPanel.Show();
    ...
    {
        LoadingPanel.SetText('Sistem sedang bersedia untuk menerima rekod Tawaran Sebutharga baharu.  Sila tunggu sebentar..');
        LoadingPanel.Show();
    ...
    function SimpanClicked()
    {
        ...
        {
            LoadingPanel.SetText('Sistem sedang menyimpan rekod Tawaran Sebutharga.  Sila tunggu sebentar..')
            LoadingPanel.Show();
    ...
    function BatalCicked()
    {
        ...
        {
            LoadingPanel.SetText('Sistem sedang memuat semula rekod Tawaran Sebutharga yang terakhir disimpan.  Sila tunggu sebentar..')
            LoadingPanel.Show();
            cbp.PerformCallback('LOAD')
        }
    }
    ...
    {
        if (
                TSH_NoSebutHarga.GetText() == '' ||
                TSH_StartDate.GetText() == '' ||
                TSH_EndDate.GetText() == '' ||
                TSH_ReservedPrice.GetText() == '' ||
                TSH_DocumentPrice.GetText() == '' ||
                TSH_Address.GetText() == ''
            )
        {
    ...
    {
        LoadingPanel.SetText('Sistem sedang memadam rekod Tawaran Sebutharga yang dipilih.  Sila tunggu sebentar..');
        LoadingPanel.Show();
...
<dx:ASPxPopupControl ID="popupSearch" runat="server" AllowDragging="True" ClientInstanceName="popupSearch" EnableClientSideAPI="True" HeaderText="Carian Tawaran Sebutharga" MaxHeight="650px" MinHeight="450px" MinWidth="650px" Modal="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter">
    <HeaderImage Url="~/Public/Images/DialogBox/Lookup.png">
    </HeaderImage>    
    <ContentCollection>
        <dx:PopupControlContentControl ID="PopupControlContentControl1" runat="server">
            <dx:ASPxGridView ID="GridSearch" runat="server" AutoGenerateColumns="False" ClientInstanceName="GridSearch" DataSourceID="SearchDs" EnableCallbackAnimation="True" KeyFieldName="TSH_ProcessID" OnCustomCallback="GridSearch_CustomCallback" Width="100%" OnHtmlDataCellPrepared="GridSearch_HtmlDataCellPrepared">
                <Columns>
                    <dx:GridViewDataTextColumn FieldName="TSH_ProcessID" ReadOnly="True" ShowInCustomizationForm="True" Visible="False" VisibleIndex="0">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="No. Rujukan" FieldName="TSH_RefNumber" ShowInCustomizationForm="True" VisibleIndex="1">
                        <HeaderStyle HorizontalAlign="Left" VerticalAlign="Bottom" Wrap="True" />
                        <CellStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True">
                        </CellStyle>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="No. Sebutharga" FieldName="TSH_NoSebutHarga" ShowInCustomizationForm="True" VisibleIndex="2">
                         <HeaderStyle HorizontalAlign="Left" VerticalAlign="Bottom" Wrap="True" />
                        <CellStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True">
                        </CellStyle>
                        <DataItemTemplate>
                            <dx:ASPxHyperLink ID="TSH_NoSebutHarga" EnableClientSideAPI="true" runat="server" Text="ASPxHyperLink">
                            </dx:ASPxHyperLink>
                        </DataItemTemplate>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataDateColumn Caption="Tarikh Mula" FieldName="TSH_StartDate" ShowInCustomizationForm="True" VisibleIndex="3" PropertiesDateEdit-DisplayFormatString="dd/MM/yyyy">
<PropertiesDateEdit DisplayFormatString="dd/MM/yyyy"></PropertiesDateEdit>
                    ...
                    <dx:GridViewDataDateColumn Caption="Tarikh Tamat" FieldName="TSH_EndDate" ShowInCustomizationForm="True" VisibleIndex="4" PropertiesDateEdit-DisplayFormatString="dd/MM/yyyy">
<PropertiesDateEdit DisplayFormatString="dd/MM/yyyy"></PropertiesDateEdit>
                    ...
                    <dx:GridViewDataTextColumn Caption="Harga Simpanan" FieldName="TSH_ReservedPrice" ShowInCustomizationForm="True" VisibleIndex="5" PropertiesTextEdit-DisplayFormatString="n">
<PropertiesTextEdit DisplayFormatString="n"></PropertiesTextEdit>
            ...
            <asp:SqlDataSource ID="SearchDs" runat="server" ConnectionString="<%$ ConnectionStrings:AMS_MasterConnectionString %>" SelectCommand="SELECT [TSH_ProcessID], [TSH_RefNumber], [TSH_NoSebutHarga], [TSH_StartDate], [TSH_EndDate], [TSH_ReservedPrice] FROM [TawaranSebutHarga_Header] ORDER BY [TSH_RefNumber]"></asp:SqlDataSource>
