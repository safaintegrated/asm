<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Tab_Pemeriksaan_Controller.ascx.cs" Inherits="AssetAndStoreManagementSystem.Aset.Pemeriksaan.Tab_Pemeriksaan_Controller" %>
...
<script>
    ...
    function btnGenerateAssInvList_Click() {
        LoadingPanel.SetText('Sistem sedang menyenaraikan semua aset alih mengikut kriteria carian.  Sila tunggu sebentar..');
        LoadingPanel.Show();
    ...
    <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" Width="100%">
        <Items>       
            <dx:LayoutGroup Caption="Maklumat Pemeriksaan" ColCount="3" Width="100%">
                <Items>
                    <dx:LayoutItem Caption="Nama Pemeriksaan" Width="70%">
                    ...
                    <dx:LayoutItem Caption="Pusat Tanggungjawab" Width="50%">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer9" runat="server">
                                <dx:ASPxComboBox ID="PEMH_PTJ" runat="server" ClientInstanceName="PEMH_PTJ" DataSourceID="PtjDs" EnableClientSideAPI="True" TextField="PTJ_FullName" ValueField="PTJ_SagaCode" ValueType="System.Int32" Width="100%">
                                </dx:ASPxComboBox>
