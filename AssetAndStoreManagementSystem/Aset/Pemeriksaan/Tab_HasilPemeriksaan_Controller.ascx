<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Tab_HasilPemeriksaan_Controller.ascx.cs" Inherits="AssetAndStoreManagementSystem.Aset.Pemeriksaan.Tab_HasilPemeriksaan_Controller" %>
