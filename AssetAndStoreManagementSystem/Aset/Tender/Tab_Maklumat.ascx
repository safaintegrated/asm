...
<script>
    ...
    {
        var TD_AssetInvUniqueId;

        for (var i = 0; i < GridList.GetVisibleRowsOnPage() ; i++)
        {
            TD_AssetInvUniqueId = ASPxClientControl.GetControlCollection().GetByName('TD_AssetInvUniqueId' + i.toString());

            if (truefalse == 'true')
                TD_AssetInvUniqueId.SetVisible(true);
            else
                TD_AssetInvUniqueId.SetVisible(false);
        }
    }
    ...
    function cbp_EndCallback(s, e)
    {
        ...
        else
        {
            ...
            else if (s.cpMode.toString() == 'LOAD')
            {
                ...
                popupSearch.Hide();
                Ref_RefProcessId.SetText(TH_ProcessID.GetText());
            ...
            else if (s.cpMode.toString() == 'DELETEITEM')
            {
                ...
                popupMsg_Label.SetText('Rekod Tender telah dipadam dengan jayanya.');
                popupMsg.Show();
                ...
                popupMsg_Label.SetText('Rekod Tender telah disimpan dengan jayanya.');
                popupMsg.Show();
...
<dx:PanelContent runat="server">
    <dx:ASPxFormLayout ID="HeaderForm" runat="server" Width="100%" ClientInstanceName="HeaderForm">
        <Items>
            <dx:LayoutGroup Caption="Maklumat Tender" ColCount="3">
                <Items>
                    <dx:LayoutItem Caption="No. Tender" Width="20%">
                          <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxTextBox ID="TH_NoTender" runat="server" ClientInstanceName="TH_NoTender" CssClass="TextBoxForId" EnableClientSideAPI="True">
                                </dx:ASPxTextBox>
                            </dx:LayoutItemNestedControlContainer>
                        </LayoutItemNestedControlCollection>
                    </dx:LayoutItem>
                    <dx:LayoutItem Caption="Alamat Peti Tender" ColSpan="2" Width="80%">
                         <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxMemo ID="TH_Address" runat="server" ClientInstanceName="TH_Address" EnableClientSideAPI="True" Rows="5" Width="50%">
	...
	s.GetInputElement().style.overflowY='hidden';
                    ...
                    <dx:LayoutItem Caption="Tarikh Mula" Width="20%">
                         <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxDateEdit ID="TH_StartDate" runat="server" ClientInstanceName="TH_StartDate" CssClass="DateEditor" DisplayFormatString="dd/MM/yyyy" EditFormat="Custom" EditFormatString="dd/MM/yyyy" EnableClientSideAPI="True">
                                </dx:ASPxDateEdit>
                            </dx:LayoutItemNestedControlContainer>                       
                        </LayoutItemNestedControlCollection>
                    </dx:LayoutItem>
                    <dx:LayoutItem Caption="Tarikh Tutup" Width="20%">
                         <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxDateEdit ID="TH_EndDate" runat="server" ClientInstanceName="TH_EndDate" CssClass="DateEditor" DisplayFormatString="dd/MM/yyyy" EditFormat="Custom" EditFormatString="dd/MM/yyyy" EnableClientSideAPI="True">
                                </dx:ASPxDateEdit>
                            </dx:LayoutItemNestedControlContainer>
                        </LayoutItemNestedControlCollection>                     
                    </dx:LayoutItem>
                    ...
                    <dx:LayoutItem Caption="Harga Simpanan (RM)" Width="20%">
                           <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxSpinEdit ID="TH_ReservedPrice" runat="server" AllowMouseWheel="False" ClientInstanceName="TH_ReservedPrice" CssClass="SpinEditForMoney" DisplayFormatString="n" EnableClientSideAPI="True" HorizontalAlign="Right" Number="0">
                    ...
                    <dx:LayoutItem Caption="Deposit Tender (RM)" Width="20%">                        
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxSpinEdit ID="TH_DocumentPrice" runat="server" AllowMouseWheel="False" ClientInstanceName="TH_DocumentPrice" CssClass="SpinEditForMoney" DisplayFormatString="n" EnableClientSideAPI="True" HorizontalAlign="Right" Number="0">
                                    <SpinButtons ShowIncrementButtons="False">
                                    </SpinButtons>
                                </dx:ASPxSpinEdit>
                            </dx:LayoutItemNestedControlContainer>
                    ...
                    <dx:LayoutItem Caption="TH_ProcessID" ShowCaption="False" Width="60%">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxTextBox ID="TH_ProcessID" runat="server" ClientInstanceName="TH_ProcessID" Width="170px" ClientVisible="False">
                                </dx:ASPxTextBox>
                            </dx:LayoutItemNestedControlContainer>
                        </LayoutItemNestedControlCollection>
                    </dx:LayoutItem>
            ...
            <dx:LayoutGroup Caption="Senarai Aset Tender">
                <Items>
                    ...
                    <dx:LayoutItem ShowCaption="False">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxGridView ID="GridList" runat="server" AutoGenerateColumns="False" ClientInstanceName="GridList" EnableCallbackAnimation="True" KeyFieldName="TD_ProcessId" OnHtmlDataCellPrepared="GridList_HtmlDataCellPrepared" Width="100%">
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="TD_ProcessId" ReadOnly="True" ShowInCustomizationForm="True" Visible="False" VisibleIndex="4">
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="Padam" FieldName="TD_AssetInvUniqueId" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="5" Width="5%">
                                            <DataItemTemplate>
                                                <dx:ASPxHyperLink ID="TD_AssetInvUniqueId" runat="server" EnableClientSideAPI="true" ImageUrl="~/Public/Images/GridIcons/GridDelete.png" Text="ASPxHyperLink">
                                                </dx:ASPxHyperLink>
                                            </DataItemTemplate>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="TD_AssetInvType" ShowInCustomizationForm="True" Visible="False" VisibleIndex="6">
                                        </dx:GridViewDataTextColumn>
                                    </Columns>
