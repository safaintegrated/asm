<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="KemaskiniAsetPelupusan_Controller.ascx.cs" Inherits="AssetAndStoreManagementSystem.Aset.KemaskiniAsetPelupusan.KemaskiniAsetPelupusan_Controller" %>
<%@ Register assembly="DevExpress.Web.v14.2, Version=14.2.3.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web" tagprefix="dx" %>




<%@ Register src="Kemaskini_Controller.ascx" tagname="Kemaskini_Controller" tagprefix="uc1" %>
...
<dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" HeaderText="Kemaskini Aset Pelupusan" Width="100%">
    <HeaderImage Url="~/Public/Images/Screen/KemaskiniAsetPelupusan.png">
    </HeaderImage>
	...
	MainRibbon_CommandExecuted(s, e);
         ...
         <tr>
            <td style="width:80%; vertical-align:top; text-align:left; padding-top:10px;">
                <uc1:Kemaskini_Controller ID="Kemaskini_Controller1" runat="server" />
             </td>
                    ...
                    <Items>
                        <dx:LayoutGroup Caption="Rujukan" Width="100%">
                            <Items>
                                ...
                                <dx:LayoutItem Caption="Tarikh Rekod" Width="100%">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
