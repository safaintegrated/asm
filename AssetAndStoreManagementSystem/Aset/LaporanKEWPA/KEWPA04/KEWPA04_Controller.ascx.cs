...
{
    public partial class KEWPA04_Controller : System.Web.UI.UserControl
    {
        ...
        protected void GridDs_Selecting(object sender, SqlDataSourceSelectingEventArgs e)
        {
            ...
            else
            {
                ...
                VarStr = "AND [RECEIVEYEAR] = " + cb_Year.Value.ToString() + " AND [PTJ_SagaCode] = '" + cb_PTJ.Value.ToString() + "' AND AIRMI_AssetInvType = 1";
