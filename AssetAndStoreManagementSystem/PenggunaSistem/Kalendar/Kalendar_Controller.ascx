<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Kalendar_Controller.ascx.cs" Inherits="AssetAndStoreManagementSystem.PenggunaSistem.Kalendar.Kalendar_Controller" %>
...
<dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" HeaderText="Kalendar Peribadi" Width="100%">
    <HeaderImage Url="~/Public/Images/Screen/Calendar.png">
    </HeaderImage>
	...
	MainRibbon_CommandExecuted(s, e);
        ...
        <tr>
            <td style="width:100%; vertical-align:top; text-align:left; padding-top:10px;">
                <dxwschs:ASPxScheduler ID="ASPxScheduler1" runat="server" ClientIDMode="AutoID" Start="2014-11-25">
                    <views>
                        <dayview>
                            <timerulers>
                                <cc1:TimeRuler />
