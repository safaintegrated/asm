<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AuditTrail_Controller.ascx.cs" Inherits="AssetAndStoreManagementSystem.PengurusanSistem.Pembekal.AuditTrail_Controller" %>
...
<dx:PopupControlContentControl ID="PopupControlContentControl1" runat="server">
	...
	GridAuditListing_EndCallback(s, e);
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn Caption="Kemaskini Oleh" FieldName="ModifiedBy" ShowInCustomizationForm="True" VisibleIndex="1" Width="65%">
                                            <DataItemTemplate>
                                        ...
                                        <dx:GridViewDataDateColumn Caption="Tarikh" FieldName="ModifiedDate" ShowInCustomizationForm="True" VisibleIndex="3" Width="20%" PropertiesDateEdit-DisplayFormatString="dd/MM/yyyy">
<PropertiesDateEdit DisplayFormatString="dd/MM/yyyy"></PropertiesDateEdit>

                                        <HeaderStyle HorizontalAlign="Left" VerticalAlign="Bottom" Wrap="True" />
                                            <CellStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True"></CellStyle>
                                        </dx:GridViewDataDateColumn>
                                        <dx:GridViewDataTextColumn Caption="Kod Pembekal" FieldName="SetVen_SAGACode" ShowInCustomizationForm="True" VisibleIndex="2" Width="15%">
                                             <HeaderStyle HorizontalAlign="Left" VerticalAlign="Bottom" Wrap="True" />
                                            <CellStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True"></CellStyle>
                                        </dx:GridViewDataTextColumn>
                                    </Columns>
                                ...
                                <asp:SqlDataSource ID="AuditMasterDs" runat="server" ConnectionString="<%$ ConnectionStrings:AMS_AuditConnectionString %>" SelectCommand="SELECT [ProcessId], [ModifiedBy], [SetVen_SAGACode], [ModifiedDate] FROM [Vendor_AuditMaster] ORDER BY [ModifiedDate] DESC"></asp:SqlDataSource>
            ...
            <dx:LayoutGroup Caption="Data Audit" Width="60%">
                <Items>
                    <dx:LayoutItem Caption="Maklumat Pendaftaran Kod Bidang">
                        <LayoutItemNestedControlCollection>
	...
	GridAuditDetails.PerformCallback();
                                ...
                                <asp:SqlDataSource ID="AuditHeaderDs" runat="server" ConnectionString="<%$ ConnectionStrings:AMS_AuditConnectionString %>" SelectCommand="SP_AuditTrail_Vendor_Certificate" SelectCommandType="StoredProcedure" OnSelecting="AuditHeaderDs_Selecting">
                                    <SelectParameters>
                    ...
                    <dx:LayoutItem Caption="Senarai Kod Bidang">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer3" runat="server">
                                <dx:ASPxGridView ID="GridAuditDetails" runat="server" AutoGenerateColumns="False" ClientInstanceName="GridAuditDetails" EnableCallbackAnimation="True" OnCustomCallback="GridAuditDetails_CustomCallback" Width="100%" DataSourceID="AuditDetailDs">
                                    <Columns>
                                        <dx:GridViewDataTextColumn Caption="Sebelum" FieldName="Before" ShowInCustomizationForm="True" VisibleIndex="0" Width="50%" ReadOnly="True">
                                             <HeaderStyle HorizontalAlign="Left" VerticalAlign="Bottom" Wrap="True" />
                                            <CellStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True">
                                            </CellStyle>
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="Selepas" FieldName="After" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="1" Width="50%">
                                            <HeaderStyle HorizontalAlign="Left" VerticalAlign="Bottom" Wrap="True" />
                                            <CellStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True">
                                            </CellStyle>
                                        </dx:GridViewDataTextColumn>
                                ...
                                <asp:SqlDataSource ID="AuditDetailDs" runat="server" ConnectionString="<%$ ConnectionStrings:AMS_AuditConnectionString %>" SelectCommand="SP_AuditTrail_Vendor_KodBidang" SelectCommandType="StoredProcedure" OnSelecting="AuditDetailDs_Selecting">
                                    <SelectParameters>
                                        <asp:Parameter DefaultValue="xx" Name="ProcessId" Type="String" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
