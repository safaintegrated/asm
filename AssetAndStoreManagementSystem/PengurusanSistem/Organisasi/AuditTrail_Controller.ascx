...
<dx:ASPxPopupControl ID="PopupAuditTrail" runat="server" ClientInstanceName="PopupAuditTrail" EnableClientSideAPI="True" Modal="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" Width="900px" HeaderText="Senarai Audit Maklumat Organisasi" AllowDragging="True" Height="550px" ScrollBars="Auto" ShowPageScrollbarWhenModal="True">
