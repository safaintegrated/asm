<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Lookup_Controller.ascx.cs" Inherits="AssetAndStoreManagementSystem.Stor.AJKPemeriksaanPelupusan.Lookup.Lookup_Controller" %>
...
<asp:SqlDataSource ID="SearchDs" runat="server" ConnectionString="<%$ ConnectionStrings:AMS_StockConnectionString %>" SelectCommand="SP_LembagaPelupusan_SearchRecords" SelectCommandType="StoredProcedure" OnSelecting="SearchDs_Selecting">
    <SelectParameters>
