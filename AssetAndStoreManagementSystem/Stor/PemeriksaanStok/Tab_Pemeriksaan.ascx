<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Tab_Pemeriksaan.ascx.cs" Inherits="AssetAndStoreManagementSystem.Stor.PemeriksaanStok.Tab_Pemeriksaan" %>
