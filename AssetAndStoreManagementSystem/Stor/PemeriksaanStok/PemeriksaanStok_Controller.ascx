<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PemeriksaanStok_Controller.ascx.cs" Inherits="AssetAndStoreManagementSystem.Stor.PemeriksaanStok.PemeriksaanStok_Controller" %>
...
<%@ Register src="Tab_Verifikasi.ascx" tagname="Tab_Verifikasi" tagprefix="uc1" %>


<%@ Register src="Tab_Info.ascx" tagname="Tab_Info" tagprefix="uc2" %>
<%@ Register src="Tab_Pemeriksaan.ascx" tagname="Tab_Pemeriksaan" tagprefix="uc3" %>
<%@ Register src="Tab_AliranKerja.ascx" tagname="Tab_AliranKerja" tagprefix="uc4" %>
...
<dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" HeaderText="Pemeriksaan Stok" Width="100%">
                                ...
                                <dx:TabPage Text="Info">
                                    <ContentCollection>
                                        <dx:ContentControl runat="server">
                                            ...
                                            <uc2:Tab_Info ID="Tab_Info1" runat="server" />
                                ...
                                <dx:TabPage Text="Pemeriksaan">
                                    <ContentCollection>
                                        <dx:ContentControl runat="server">
                                            ...
                                            <uc3:Tab_Pemeriksaan ID="Tab_Pemeriksaan1" runat="server" />
                                            
                                        </dx:ContentControl>
                                    </ContentCollection>
                                </dx:TabPage>
                                <dx:TabPage Text="Verifikasi">
                                    <ContentCollection>
                                        <dx:ContentControl runat="server">
                                            
                                            <uc1:Tab_Verifikasi ID="Tab_Verifikasi1" runat="server" />
                                ...
                                <dx:TabPage Text="Aliran Kerja">
                                    <ContentCollection>
                                        <dx:ContentControl runat="server">
                                            ...
                                            <uc4:Tab_AliranKerja ID="Tab_AliranKerja1" runat="server" />
