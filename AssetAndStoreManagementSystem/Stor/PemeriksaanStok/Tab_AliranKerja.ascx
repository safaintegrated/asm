<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Tab_AliranKerja.ascx.cs" Inherits="AssetAndStoreManagementSystem.Stor.PemeriksaanStok.Tab_AliranKerja" %>
