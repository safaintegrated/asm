<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VerifikasiStok_Controller.ascx.cs" Inherits="AssetAndStoreManagementSystem.Stor.VerifikasiStok.VerifikasiStok_Controller" %>
