<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Tab_SenaraiSemak_Controller.ascx.cs" Inherits="AssetAndStoreManagementSystem.Stor.PermohonanBelian_Stor.Tab_SenaraiSemak_Controller" %>
...
<script>
    ...
    {
        if (VerifyPRChecklist())
            cbp_PR_Checklist.PerformCallback('SAVE');
    }

    function cbp_PR_Checklist_EndCallback(s, e)
    {
    ...
    function VerifyPRChecklist()
    {
        var lpass = true;
        var Checkx;
        var DC_Mandatory;

        for (var i = 0; i < GridPrChecklist.GetVisibleRowsOnPage() ; i++)
        {
...
<dx:ASPxCallbackPanel ID="cbp_PR_Checklist" runat="server" ClientInstanceName="cbp_PR_Checklist" EnableCallbackAnimation="True" OnCallback="cbp_PR_Checklist_Callback" ShowLoadingPanel="False" ShowLoadingPanelImage="False" Width="100%">
    <PanelCollection>
                    ...
                    <dx:LayoutItem ShowCaption="False" Width="100%">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxGridView ID="GridPrChecklist" runat="server" AutoGenerateColumns="False" ClientInstanceName="GridPrChecklist" Width="100%" OnHtmlDataCellPrepared="GridPrChecklist_HtmlDataCellPrepared">
                                    <Columns>
