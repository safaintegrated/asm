...
namespace AssetAndStoreManagementSystem.Stor.PermohonanBelian_Stor
{
    public partial class Tab_Permohonan : System.Web.UI.UserControl
    {
        ...
        protected void cbp_Header_Callback(object sender, DevExpress.Web.CallbackEventArgsBase e)
        {
        ...
        void LoadHeader()
        {
            ...
            try
            {
                ...
                if (err == "")
                {
                    ...
                    PRH_SetVen_Name.Value = Dt.Rows[0]["PRH_SetVen_SAGACode"].ToString();
        ...
        void PostHeader(string CurrUser)
        {
            ...
            try
            {
                ...
                if (err == string.Empty)
                {
                    ...
                    PenggunaSistemMethods.GetSystemUserNamePelupusan(ref ApplicantName, CurrUser);
        ...
        void PopulateDt(ref DataTable Dt)
        {
            ...
            Dr["PRH_SetVen_Name"] = PRH_SetVen_Name.GridView.GetRowValues(PRH_SetVen_Name.GridView.FocusedRowIndex, "SetVen_Name").ToString();
        ...
        protected void PRH_SetVen_Name_Init(object sender, EventArgs e)
        {
            ASPxGridLookup PRH_SetVen_Name = (ASPxGridLookup)sender;
            ASPxGridView PRH_SetVen_NameGridView = PRH_SetVen_Name.GridView;
            PRH_SetVen_NameGridView.CustomCallback += PRH_SetVen_NameGridView_CustomCallback;
        }

        void PRH_SetVen_NameGridView_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ASPxGridView PRH_SetVen_NameGridView = (ASPxGridView)sender;
            PRH_SetVen_NameGridView.DataBind();
        }
    }
}