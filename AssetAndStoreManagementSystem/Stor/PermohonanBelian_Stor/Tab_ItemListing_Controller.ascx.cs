...
namespace AssetAndStoreManagementSystem.Stor.PermohonanBelian_Stor
{
    public partial class Tab_ItemListing_Controller : System.Web.UI.UserControl
    {
        ...
        protected void GridPRItemListing_HtmlDataCellPrepared(object sender, DevExpress.Web.ASPxGridViewTableDataCellEventArgs e)
        {
        ...
        protected void cbp_GenerateNewItem_Callback(object sender, DevExpress.Web.CallbackEventArgsBase e)
        {
        ...
        protected void cbp_deletePrItem_Callback(object sender, DevExpress.Web.CallbackEventArgsBase e)
        {
