<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Verifikasi_Controller.ascx.cs" Inherits="AssetAndStoreManagementSystem.Stor.Verifikasi.Verifikasi_Controller" %>
	...
	MainRibbon_CommandExecuted(s, e);
        ...
        <tr>
            <td style="width:80%; vertical-align:top; text-align:left; padding-top:10px;">
                <dx:ASPxPageControl ID="PageControl" runat="server" ActiveTabIndex="1" Width="100%" ClientInstanceName="PageControl" EnableClientSideAPI="True">
                    <TabPages>
