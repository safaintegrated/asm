<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LantikanAJKPenyiasat_Controller.ascx.cs" Inherits="AssetAndStoreManagementSystem.Stor.LantikanAJKPenyiasat.LantikanAJKPenyiasat_Controller" %>
...
<dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" HeaderText="Lantikan Ahli Jawatankuasa" Width="100%">
                            ...
                            <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" ColCount="2" Width="100%">
                                <Items>
                                    <dx:LayoutGroup Caption="Maklumat Ahli Jawatankuasa" ColCount="3" Width="80%">
                                        <Items>
                                            <dx:LayoutItem Caption="Nama Ahli JawatanKuasa" Width="35%">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxTextBox ID="txtNamaAhliJawatanKuasa" runat="server" ClientInstanceName="txtNamaAhliJawatanKuasa" CssClass="TextBoxForName" EnableClientSideAPI="True" Width="100%">
                                                        </dx:ASPxTextBox>
                                            ...
                                            <dx:LayoutGroup ColCount="4" ColSpan="3" GroupBoxDecoration="None">
                                                ...
                                                <Items>
                                                    <dx:LayoutItem Caption="Tahun Pemeriksaan" Width="7%">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxSpinEdit ID="txtTahunPemeriksaan" runat="server" AllowMouseWheel="False" ClientInstanceName="txtTahunPemeriksaan" CssClass="DateEditor" EnableClientSideAPI="True" NumberType="Integer" Width="100%">
                                                    ...
                                                    <dx:LayoutItem Caption="Tarikh Mula Lantikan" Width="8%">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxDateEdit ID="deTarikhMulaLantikan" runat="server" ClientInstanceName="deTarikhMulaLantikan" CssClass="DateEditor" DisplayFormatString="dd/MM/yyyy" EditFormat="Custom" EditFormatString="dd/MM/yyyy" EnableClientSideAPI="True" Width="100%">
                                                                </dx:ASPxDateEdit>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                                    <dx:LayoutItem Caption="Tarikh Tamat Lantikan" Width="8%">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                                <dx:ASPxDateEdit ID="deTarikhTamatLantikan" runat="server" ClientInstanceName="deTarikhTamatLantikan" CssClass="DateEditor" DisplayFormatString="dd/MM/yyyy" EditFormat="Custom" EditFormatString="dd/MM/yyyy" EnableClientSideAPI="True" Width="100%">
                                                                </dx:ASPxDateEdit>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                    ...
                                    <dx:LayoutGroup Caption="Ahli JawatanKuasa" ColSpan="2">
                                        <Items>
                                            ...
                                            <dx:LayoutItem ShowCaption="False">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxHyperLink ID="LinkLookupEmployee" runat="server" ClientInstanceName="LinkLookupEmployee" CssClass="myHyperlink" EnableClientSideAPI="True" Text="Pilih Ahli Jawatankuasa Penyiasat" NavigateUrl="javascript: LookupAhliLembaga();">
                                                        </dx:ASPxHyperLink>
                                                    </dx:LayoutItemNestedControlContainer>
                                                </LayoutItemNestedControlCollection>
                                            </dx:LayoutItem>
