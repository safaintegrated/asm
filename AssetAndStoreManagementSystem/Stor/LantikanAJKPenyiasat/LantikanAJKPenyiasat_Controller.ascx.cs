...
{
    public partial class LantikanAJKPenyiasat_Controller : System.Web.UI.UserControl
    {
        ...
        void LembagaPemeriksaNewMode(string CurrUser)
        {
            ...
            try
            {
                LPH_UniqueId.Text = "";
                LPH_RefNumber.Text = "";
                txtNamaAhliJawatanKuasa.Text = "";
                txtTahunPemeriksaan.Value = DBNull.Value;
                deTarikhMulaLantikan.Value = DBNull.Value;
                deTarikhTamatLantikan.Value = DBNull.Value;
                ...
                else
                {
                    ...
                    if (err == string.Empty)
                    {
                        ...
                        else
                        {
                            ...
                            txtNamaAhliJawatanKuasa.Text = DtHeader.Rows[0]["LPH_LembagaName"].ToString();
                            //LPH_AssignedPtj.Value = Convert.ToInt32(DtHeader.Rows[0]["LPH_AssignedPtj"]);
                            txtTahunPemeriksaan.Value = Convert.ToInt32(DtHeader.Rows[0]["LPH_AssignYear"]);
                            deTarikhMulaLantikan.Value = Convert.ToDateTime(DtHeader.Rows[0]["LPH_StartDate"]);
                            deTarikhTamatLantikan.Value = Convert.ToDateTime(DtHeader.Rows[0]["LPH_EndDate"]);
        ...
        void LembagaPemeriksaRefresh()
        {
            ...
            try
            {
                string err = LembagaPemeriksaMethods.V_LembagaPemeriksa_Header_Refresh(txtTahunPemeriksaan.Text, ref DtHeader);
            ...
            try
            {
                ...
                if (err == "")
                {
                    if (Post == 2)
                    {
                        ...
                        //SendMail.LembagaPemeriksa_NotifyMembers(ref EmailDt, Server.MapPath(ConfigurationManager.AppSettings["EmailXmlFilePath"].ToString()), txtNamaAhliJawatanKuasa.Text, txtTahunPemeriksaan.Text, deTarikhMulaLantikan.Text, deTarikhTamatLantikan.Text, CreatorName);
                    }
                    else if (Post == 3)
                    {
                        LPH_UniqueId.Text = "";
        ...
        void PopulateHeaderTVP(ref DataTable Dt)
        {
            ...
            Dr["LPH_LembagaName"] = txtNamaAhliJawatanKuasa.Text.Trim();
            //Dr["LPH_AssignedPtj"] = Convert.ToInt32(LPH_AssignedPtj.Value);
            Dr["LPH_AssignYear"] = Convert.ToInt32(txtTahunPemeriksaan.Value);
            Dr["LPH_StartDate"] = deTarikhMulaLantikan.Date;
            Dr["LPH_EndDate"] = deTarikhTamatLantikan.Date;
