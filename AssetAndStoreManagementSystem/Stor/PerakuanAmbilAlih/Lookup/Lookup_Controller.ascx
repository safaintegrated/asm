<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Lookup_Controller.ascx.cs" Inherits="AssetAndStoreManagementSystem.Stor.PerakuanAmbilAlih.Lookup.Lookup_Controller" %>
...
<dx:ASPxGridView ID="GridLookupLembagaPemeriksa" runat="server" AutoGenerateColumns="False" ClientInstanceName="GridLookupLembagaPemeriksa" DataSourceID="SearchDs" EnableCallbackAnimation="True" KeyFieldName="LPH_LembagaName" Width="100%" OnHtmlDataCellPrepared="GridLookupLembagaPemeriksa_HtmlDataCellPrepared">
    <Columns>
        ...
        <dx:GridViewDataTextColumn Caption="Nama Pegawai Stor Baru" FieldName="LPH_LembagaName" ReadOnly="True" VisibleIndex="1" Width="12%">
             <HeaderStyle HorizontalAlign="Left" VerticalAlign="Bottom" Wrap="True" />
            <CellStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True"></CellStyle>   
            <DataItemTemplate>
        ...
        <dx:GridViewDataTextColumn Caption="EmployrrDesignation" FieldName="LPH_AssignYear" VisibleIndex="3" Width="5%">
             <HeaderStyle HorizontalAlign="Left" VerticalAlign="Bottom" Wrap="True" />
            <CellStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True"></CellStyle>   
        </dx:GridViewDataTextColumn>
...
<PropertiesDateEdit DisplayFormatString="dd/MM/yyyy"></PropertiesDateEdit>
        ...
        <dx:GridViewDataTextColumn Caption="Email Pegawai Baru" FieldName="TotalMembers" ReadOnly="True" VisibleIndex="6" Width="7%">
