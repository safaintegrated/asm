<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PelarasanStok_Controller.ascx.cs" Inherits="AssetAndStoreManagementSystem.Stor.PelarasanStok.PelarasanStok_Controller" %>
...
<dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" HeaderText="Pelarasan Stok" Width="100%">
    <HeaderImage Url="~/Public/Images/Screen/PelarasanStok.png">
    </HeaderImage>
                ...
                <LayoutItemNestedControlCollection>
                    <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer2" runat="server">
                        ...
                        <dx:ASPxFormLayout ID="ASPxFormLayout3" runat="server" Width="100%">
                            <Items>
                                <dx:LayoutGroup Caption="Maklumat Pelarasan Stok" Width="100%">
                                    <Items>
                                ...
                                <dx:LayoutGroup Caption="Senarai Stok Yang Dilaraskan" Width="100%">
                                    <Items>
