<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Stok_Controller.ascx.cs" Inherits="AssetAndStoreManagementSystem.Stor.Stok.Stok_Controller" %>
...
<dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" HeaderText="Stok" Width="100%">
    <HeaderImage Url="~/Public/Images/Screen/Stock.png">
    </HeaderImage>
...
<dx:PanelContent runat="server">
    <table  style="width:100%; vertical-align:top; text-align:left;">
        <tr>
            <td style="width:100%; vertical-align:top; text-align:left; padding-top:10px"><dx:ASPxRibbon ID="MainRibbon" runat="server" ShowFileTab="False" ClientInstanceName="MainRibbon" Width="100%">
    <Tabs>
            ...
            <td style="width:100%; vertical-align:top; text-align:left; padding-top:10px">
                <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" ColCount="2" Width="100%">
                    <Items>
                        <dx:LayoutItem ColSpan="2" ShowCaption="False">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                                    <div style="width:60%; vertical-align:top; text-align:left;margin-left:auto; margin-right:auto; padding-bottom:15px;">
                                        <dx:ASPxImageSlider ID="ASPxImageSlider1" runat="server" BinaryImageCacheFolder="~\Thumb\" Height="300px" Width="100%">
                                            <SettingsAutoGeneratedImages ImageCacheFolder="~\Thumb\" ImageHeight="440px" />
                                        </dx:ASPxImageSlider>
                                    </div>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        </dx:LayoutItem>
                        <dx:LayoutItem Caption="No. Daftar Stok" ColSpan="2" Width="100%">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                                    <dx:ASPxTextBox ID="ASPxFormLayout1_E1" runat="server" CssClass="TextboxNoDaftarStok">
                                    </dx:ASPxTextBox>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        </dx:LayoutItem>
                        <dx:LayoutItem Caption="Keterangan Stok" ColSpan="2" Width="100%">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                        ...
                        <dx:LayoutItem Caption="Kumpulan Stok" Width="20%">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                        ...
                        <dx:LayoutItem Caption="Unit Pengukuran" Width="80%">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                        ...
                        <dx:LayoutItem Caption="Sub-Kategori" Width="80%">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
