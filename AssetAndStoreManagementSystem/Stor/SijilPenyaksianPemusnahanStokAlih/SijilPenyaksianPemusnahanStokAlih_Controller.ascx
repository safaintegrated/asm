<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SijilPenyaksianPemusnahanStokAlih_Controller.ascx.cs" Inherits="AssetAndStoreManagementSystem.Stor.SijilPenyaksianPemusnahanStokAlih.SijilPenyaksianPemusnahanStokAlih_Controller" %>
<%@ Register assembly="DevExpress.Web.v14.2, Version=14.2.3.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web" tagprefix="dx" %>



<%@ Register src="Tab_SijilPenyaksianPemusnahanStokAlih.ascx" tagname="Tab_SijilPenyaksianPemusnahanStokAlih" tagprefix="uc1" %>
<%@ Register src="Tab_SijilPelupusanStokAlih.ascx" tagname="Tab_SijilPelupusanStokAlih" tagprefix="uc2" %>
<%@ Register src="Tab_LaporanTahunanPelupusanStokAlih.ascx" tagname="Tab_LaporanTahunanPelupusanStokAlih" tagprefix="uc3" %>
...
<script>
    ...
    {
        var v = CheckSijilPenyaksianPemusnahanStokAlih();
        if (v == true) {
            alert('1')
            ...
            LoadingPanel.Show();
            alert('3')
            cbpSijilPengesahanPemusnahanStokAlih.PerformCallback('SAVE')
            alert('4')
        }
        else {
            alert('5');
    ...
    function CheckSijilPenyaksianPemusnahanStokAlih() {

        if (glFakultiPTJ.GetText() == '') {
            popupMsg_Label.SetText('Nama Fakulti atau PTJ perlu diisi terlebih dahulu.<br>Sila semak dan cuba sekali lagi.');
            popupMsg.Show();
            return false;
        }

        if (txtUnitMakmal.GetText() == '') {
            popupMsg_Label.SetText('Unit atau Makmal perlu diisi terlebih dahulu.<br>Sila semak dan cuba sekali lagi.');
            popupMsg.Show();
            return false;
        }
        ...
        if (glSecara.GetText() == '') {
            popupMsg_Label.SetText('Secara perlu diisi terlebih dahulu.<br>Sila semak dan cuba sekali lagi.');
            popupMsg.Show();
            return false;
        }
        ...
        if (txtTempat.GetText() == '') {
            popupMsg_Label.SetText('Tempat Tutup Sebutharga perlu diisi terlebih dahulu.<br>Sila semak dan cuba sekali lagi.');
            popupMsg.Show();
            return false;
        }
                                ...
                                <dx:TabPage Text="Kenyataan Tawaran Tender Pelupusan">
                                    <ContentCollection>
                                        <dx:ContentControl runat="server">
                                            ...
                                            <uc1:Tab_SijilPenyaksianPemusnahanStokAlih ID="Tab_SijilPenyaksianPemusnahanStokAlih" runat="server" />
                                ...
                                <dx:TabPage Text="Borang Tender Pelupusan Aset Alih">
                                    <ContentCollection>
                                        <dx:ContentControl runat="server">
                                            ...
                                            <uc2:Tab_SijilPelupusanStokAlih ID="Tab_SijilPelupusanStokAlih" runat="server" />
                                ...
                                <dx:TabPage Text="Jadual Tender Pelupusan Aset Alih">
                                    <ContentCollection>
                                        <dx:ContentControl runat="server">
                                            ...
                                            <uc3:Tab_LaporanTahunanPelupusanStokAlih ID="Tab_LaporanTahunanPelupusanStokAlih" runat="server" />
