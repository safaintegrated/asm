<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AmbilAlih_Controller.ascx.cs" Inherits="AssetAndStoreManagementSystem.Stor.AmbilAlih.AmbilAlih_Controller" %>
...
<dx:PanelContent runat="server">
                    ...
                    <PanelCollection>
                        <dx:PanelContent runat="server">
                            <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" ColCount="2" Width="100%">
                                <Items>
                                    <dx:LayoutGroup Caption="Maklumat Stok Yang Diperiksa" ColCount="3" Width="80%">
                                        <Items>
                                            <dx:LayoutItem Caption="No Daftar Stok" Width="45%">
	...
	s.GetGridView().SetWidth(550);
                                            ...
                                            <dx:LayoutItem Caption="Nama Lembaga" Width="35%">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                            ...
                                            <dx:LayoutItem Caption="Status Pemeriksaan">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                            ...
                                            <dx:LayoutGroup ColCount="4" ColSpan="3" GroupBoxDecoration="None" Visible="False">
                                                <GroupBoxStyle>
