...
namespace AssetAndStoreManagementSystem.Shared.TerimaanBarang
{
    public partial class Tab_SenaraiSemak_Controller : System.Web.UI.UserControl
    {
        ...
        void LoadCheckList()
        {
            ...
            try
            {
                string err = TerimaanBarangMethods.SP_GRN_GetChecklist(chkList_ProcessId.Text, ref Ds);
        ...
        void SaveChecklist(string CurrUser)
        {
            ...
            try
            {
                ...
                string err = TerimaanBarangMethods.SP_GRN_SaveChecklist(chkList_ProcessId.Text, Username, ref Dt);
                ...
                if (err == string.Empty)
                {
                    ...
                    TerimaanBarangMethods.SP_GRN_GetChecklist(chkList_ProcessId.Text, ref Ds);
                    GridChecklist.DataSource = Ds.Tables[1];
                    GridChecklist.KeyFieldName = "DC_RowId";
                    GridChecklist.DataBind();
                    GridChecklist.Enabled = false;
